...
export default function ProjectCard({ project }: { project: ProjectCardData }) {
  ...
  return (
    <motion.div
      ...
      className="group relative overflow-hidden rounded-[14px] border border-line bg-white/[0.04] p-5 backdrop-blur-md transition-colors hover:border-primary/40"
    >
      {!reduce && (
        <div
          aria-hidden
      ...
      {/* Content sits above the stretched link but is click-through, except the GitHub link */}
